...
public static class SilverBulletPool
{
    private static List<BulletManager.BulletInfo> bullets = new List<BulletManager.BulletInfo>();
    private static readonly  BulletManager.BulletType type = BulletManager.BulletType.Silver;
    ...
    public static List<Transform> AddBullet()
    {
